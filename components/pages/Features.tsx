  ...
  return (
    <div className="h-screen flex items-center justify-center">
      <div className="w-full max-w-[400px] h-full min-h-screen bg-white shadow-2xl mx-auto relative overflow-hidden">
        <div className={`w-full h-full relative shadow-2xl overflow-hidden`}>
          <div
            className={`absolute w-full max-w-[450px] h-20 bg-white bottom-0 z-30 flex flex-row justify-between px-2 text-gray-300 items-center`}
          >
          ...
          <div ref={containerRef} className="h-full w-full">
            <ScrollableFeed
              className={`bg-[#fff8ff] w-full h-full flex flex-col items-center relative px-4 py-8 justify-between pb-32 scroll-feed`}
            >
              <div className="flex flex-col space-y-5 w-full z-10">
                ...
                <div className="relative">
                  <IconSearch
                    size={20}
                    className="absolute bottom-1/2 translate-y-1/2 left-3 text-gray-400"
                  />
                  <input
                    type="text"
                    className="w-full border border-gray-300 rounded-lg py-2 pl-10 pr-2"
                  ...
                  <div className="flex flex-col space-y-4">
                    ...
                    <div className="grid grid-cols-4 w-full gap-y-10 text-[0.7rem] text-center text-nowrap">
                      <div className="rounded-full w-12 h-12 bg-[#f678bd] relative mx-auto">
                        <p className="absolute -bottom-5 text-center w-fit right-1/2 translate-x-1/2">
                          Tumbuh Anak
                        </p>
                      </div>
                      <div className="rounded-full w-12 h-12 bg-[#f678bd] relative mx-auto">
                      ...
                      <a
                        className="rounded-full w-12 h-12 relative mx-auto items-center flex"
                        href="/select-profile/"
                      >
                        <img
                          src="/elements/logo.svg"
                          className="w-14 h-14 relative mx-auto"
                          alt="NuSantap"
                        />
                        <p className="absolute -bottom-5 text-center w-fit right-1/2 translate-x-1/2 font-semibold">
                          NuSantap
                        </p>
